all:
	...
	@echo Pruebe a ejecutar el algoritmo iterativo con ./laMayoriaAbsolutaIterativo.bin salida.txt 123512 1000 2 2000 10 3000 20 4000 30
	@echo Pruebe a ejecutar el algoritmo recursivo con ./laMayoriaAbsolutaIterativo.bin salida.txt 1000 2000 3000 4000 5000 6000 7000 8000 9000 10000
	...
	@echo Pruebe a ejecutar el algoritmo iterativo con ./Tuercas_Iterativo.bin salida.txt 123512 1000 2000 3000 4000 5000 6000 7000 8000 9000 10000
